...
Ready-to-install [abap2UI5](https://github.com/abap2UI5/abap2UI5) for **ABAP for Cloud** (`if_http_service_extension`), generated from **abap2UI5 v1.144.1**. Runs on the BTP ABAP Environment, S/4HANA Cloud and any system restricted to the ABAP Cloud language version.
